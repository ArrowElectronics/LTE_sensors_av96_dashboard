  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      3: [
        function (t, e) {
          ...
          var r = (t('./url'), t('engine.io-client')),
            ...
            c = t('component-bind'),
            p =
              (t('object-component'), t('debug')('socket.io-client:manager')),
            u = t('indexof'),
            f = t('backo2');
          (e.exports = n),
          ...
          i(r.prototype),
            ...
            (r.prototype.onopen = function () {
              p('transport is open - connecting'),
                '/' != this.nsp && this.packet({ type: o.CONNECT });
            }),
        ...
        function (t, e) {
          ...
          (e.exports = n),
            ...
            (n.enable = function (t) {
              ...
              for (
                var r = (t || '').split(/[\s,]+/), o = r.length, i = 0;
                o > i;
                i++
              )
                (t = r[i].replace('*', '.*?')),
      ...
      23: [
        function (t, e, n) {
          ...
          function i(t) {
            n.save(t);
            for (
              var e = (t || '').split(/[\s,]+/), r = e.length, o = 0;
              r > o;
              o++
            )
              e[o] &&
      ...
      24: [
        function (t, e) {
          function n(t) {
            var e = /^((?:\d+)?\.?\d+) *(ms|seconds?|s|minutes?|m|hours?|h|days?|d|years?|y)?$/i.exec(
              t
            );
            if (e) {
          ...
          e.exports = function (t, e) {
            return (
              (e = e || {}), 'string' == typeof t ? n(t) : e.long ? o(t) : r(t)
            );
          };
        },
        {},
        ...
        function (t, e, n) {
          (function (e) {
            ...
            (n.encodePacket = function (t, n, i, a) {
              ...
              return (
                void 0 !== t.data &&
                  (p += i ? l.encode(String(t.data)) : String(t.data)),
                a('' + p)
              );
            }),
              ...
              (n.decodeBase64Packet = function (t, n) {
                var r = v[t.charAt(0)];
                if (!e.ArrayBuffer)
                  return { type: r, data: { base64: !0, data: t.substr(1) } };
                var o = f.decode(t.substr(1));
                return (
                  'blob' === n && w && (o = new w([o])), { type: r, data: o }
                );
              }),
              ...
              (n.decodePayloadAsBinary = function (t, e, r) {
                ...
                for (var o = t, i = [], s = !1; o.byteLength > 0; ) {
                  for (
                    var a = new Uint8Array(o), c = 0 === a[0], p = '', f = 1;
                    255 != a[f];
                    f++
                  ) {
                    if (p.length > 310) {
            ...
            function r(t) {
              function e(t) {
                ...
                if (o(t)) {
                  ...
                  t.toJSON && (t = t.toJSON());
                  for (var i in t)
                    if (t.hasOwnProperty(i) && e(t[i])) return !0;
                }
                return !1;
              }
              return e(t);
      ...
      49: [
        function (e, n, r) {
          !(function (e) {
            ...
            u && p
              ? ((u.stringify = p.stringify), (u.parse = p.parse))
              : (u = e.JSON = p || {});
